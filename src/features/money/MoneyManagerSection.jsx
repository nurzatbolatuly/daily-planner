...
export default function MoneyManagerSection() {
  ...
  if (screen) {
    ...
    const screenMap = {
      ...
      transfer:     ()  => <TransferPageMon accounts={data.accounts} expCats={data.expCats} goals={data.goals} transactions={data.transactions} fxAccount={data.accounts.find(a => a.is_fx_account)} onBack={goBack}/>,
      ...
      editTransfer: (d) => <TransferPageMon accounts={data.accounts} expCats={data.expCats} goals={data.goals} transactions={data.transactions} fxAccount={data.accounts.find(a => a.is_fx_account)} onBack={goBack} edit={d}/>,
